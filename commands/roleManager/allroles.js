...
module.exports.run = (client, message) => {
    ...
    const embed1A = new MessageEmbed()
        ...
        .setDescription("Ecrivez dans ce channel \"__Yui role @1A-XX__\" pour avoir votre TD !")
        .setColor("#dc143c")
        .addField(
    ...
    const embed2A = new MessageEmbed()
        ...
        .setDescription("Ecrivez dans ce channel \"__Yui role @2A-XX__\" pour avoir votre TD !")
        .setColor("#dc143c")
        .addField(
            "Les rôles disponibles:",
            `
    ...
    const embed3A = new MessageEmbed()
        ...
        .setDescription("Ecrivez dans ce channel \"__Yui role @3A-XX__\" pour avoir votre TD !")
        .setColor("#dc143c")
        .addField(
            "Les rôles disponibles:",
            `
    ...
    const embed4A = new MessageEmbed()
        ...
        .setDescription("Ecrivez dans ce channel \"__Yui role @4A-XX__\" pour avoir votre TD !")
        .setColor("#dc143c")
        .addField(
            "Les rôles disponibles:",
            `
