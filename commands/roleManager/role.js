module.exports.run = (client, message, args) => {
  ...
  const channel1A = message.guild.channels.cache.find(
    (c) => c.id === '772021354944790550'
  )
  const channel2A = message.guild.channels.cache.find(
    (c) => c.id === '772024026414448673'
  )
  const channel3A = message.guild.channels.cache.find(
    (c) => c.id === '772024054135128064'
  )
  const channel4A = message.guild.channels.cache.find(
    (c) => c.id === '772024086636527636'
  )
  ...
  const wanted_role = message.guild.roles.cache.get(
    argued_role.replace('<@&', '').replace('>', '')
  )
    ...
    case channel1A:
      ...
      switch (wanted_role) {
        case Role_1A_TDA1:
          ...
          channel_log.send(
            `Role ${Role_1A_TDA1.name} add to ${member.displayName}`
          )
          break
        case Role_1A_TDA2:
          member.roles.add(Role_1A_TDA2)
          channel_log.send(
            `Role ${Role_1A_TDA2.name} add to ${member.displayName}`
          )
          break
        case Role_1A_TDA3:
          member.roles.add(Role_1A_TDA3)
          channel_log.send(
            `Role ${Role_1A_TDA3.name} add to ${member.displayName}`
          )
          break
        case Role_1A_TDA4:
          member.roles.add(Role_1A_TDA4)
          channel_log.send(
            `Role ${Role_1A_TDA4.name} add to ${member.displayName}`
          )
          break
        case Role_1A_TDB1:
          member.roles.add(Role_1A_TDB1)
          channel_log.send(
            `Role ${Role_1A_TDB1.name} add to ${member.displayName}`
          )
          break
        case Role_1A_TDB2:
          member.roles.add(Role_1A_TDB2)
          channel_log.send(
            `Role ${Role_1A_TDB2.name} add to ${member.displayName}`
          )
          break
        case Role_1A_TDB3:
          member.roles.add(Role_1A_TDB3)
          channel_log.send(
            `Role ${Role_1A_TDB3.name} add to ${member.displayName}`
          )
          break
        case Role_1A_TDSIB:
          member.roles.add(Role_1A_TDSIB)
          channel_log.send(
            `Role ${Role_1A_TDSIB.name} add to ${member.displayName}`
          )
          break
      }
      break
    case channel2A:
      ...
      switch (wanted_role) {
        case Role_2A_BLOIS_TD1:
          ...
          channel_log.send(
            `Role ${Role_2A_BLOIS_TD1.name} add to ${member.displayName}`
          )
          break
        case Role_2A_BLOIS_TD2:
          member.roles.add(Role_2A_BLOIS_TD2)
          channel_log.send(
            `Role ${Role_2A_BLOIS_TD2.name} add to ${member.displayName}`
          )
          break
        case Role_2A_BLOIS_TD3:
          member.roles.add(Role_2A_BLOIS_TD3)
          channel_log.send(
            `Role ${Role_2A_BLOIS_TD3.name} add to ${member.displayName}`
          )
          break
        case Role_2A_BOURGES_TD1:
          member.roles.add(Role_2A_BOURGES_TD1)
          channel_log.send(
            `Role ${Role_2A_BOURGES_TD1.name} add to ${member.displayName}`
          )
          break
        case Role_2A_BOURGES_TD2:
          member.roles.add(Role_2A_BOURGES_TD2)
          channel_log.send(
            `Role ${Role_2A_BOURGES_TD2.name} add to ${member.displayName}`
          )
          break
        case Role_2A_BOURGES_TD3:
          member.roles.add(Role_2A_BOURGES_TD3)
          channel_log.send(
            `Role ${Role_2A_BOURGES_TD3.name} add to ${member.displayName}`
          )
          break
        case Role_2A_BOURGES_TD4:
          member.roles.add(Role_2A_BOURGES_TD4)
          channel_log.send(
            `Role ${Role_2A_BOURGES_TD4.name} add to ${member.displayName}`
          )
          break
      }
      break
    ...
    case channel4A:
      ...
      switch (wanted_role) {
        case Role_4A_GSI_TD1:
          ...
          channel_log.send(
            `Role ${Role_4A_GSI_TD1.name} add to ${member.displayName}`
          )
          break
        case Role_4A_GSI_TD2:
          member.roles.add(Role_4A_GSI_TD2)
          channel_log.send(
            `Role ${Role_4A_GSI_TD2.name} add to ${member.displayName}`
          )
          break
        case Role_4A_GSI_TD3:
          member.roles.add(Role_4A_GSI_TD3)
          channel_log.send(
            `Role ${Role_4A_GSI_TD3.name} add to ${member.displayName}`
          )
          break
        case Role_4A_GSI_TD4:
          member.roles.add(Role_4A_GSI_TD4)
          channel_log.send(
            `Role ${Role_4A_GSI_TD4.name} add to ${member.displayName}`
          )
          break
        case Role_4A_GSI_TD5:
          member.roles.add(Role_4A_GSI_TD5)
          channel_log.send(
            `Role ${Role_4A_GSI_TD5.name} add to ${member.displayName}`
          )
          break
        case Role_4A_MRI_TD1:
          member.roles.add(Role_4A_MRI_TD1)
          channel_log.send(
            `Role ${Role_4A_MRI_TD1.name} add to ${member.displayName}`
          )
          break
        case Role_4A_MRI_TD2:
          member.roles.add(Role_4A_MRI_TD2)
          channel_log.send(
            `Role ${Role_4A_MRI_TD2.name} add to ${member.displayName}`
          )
          break
        case Role_4A_MRI_TD3:
          member.roles.add(Role_4A_MRI_TD3)
          channel_log.send(
            `Role ${Role_4A_MRI_TD3.name} add to ${member.displayName}`
          )
          break
        case Role_4A_MRI_TD4:
          member.roles.add(Role_4A_MRI_TD4)
          channel_log.send(
            `Role ${Role_4A_MRI_TD4.name} add to ${member.displayName}`
          )
          break
        case Role_4A_STI_TD1:
          member.roles.add(Role_4A_STI_TD1)
          channel_log.send(
            `Role ${Role_4A_STI_TD1.name} add to ${member.displayName}`
          )
          break
        case Role_4A_STI_TD2:
          member.roles.add(Role_4A_STI_TD2)
          channel_log.send(
            `Role ${Role_4A_STI_TD2.name} add to ${member.displayName}`
          )
          break
        case Role_4A_STI_TD3:
          member.roles.add(Role_4A_STI_TD3)
          channel_log.send(
            `Role ${Role_4A_STI_TD3.name} add to ${member.displayName}`
          )
          break
        case Role_4A_ERE_TD1:
          member.roles.add(Role_4A_ERE_TD1)
          channel_log.send(
            `Role ${Role_4A_ERE_TD1.name} add to ${member.displayName}`
          )
          break
        case Role_4A_ERE_TD2:
          member.roles.add(Role_4A_ERE_TD2)
          channel_log.send(
            `Role ${Role_4A_ERE_TD2.name} add to ${member.displayName}`
          )
          break
      }
      break
